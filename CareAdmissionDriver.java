...
public class CareAdmissionDriver {
    ...
    // welcome, goodbye, and syntax error messages
        ...
        if (commands.length < 4) {
            ...
            try {
                ...
                if (commands[2].length() != 1) {
                    System.out.println(SYNTAX_ERROR_MSG
                            + " Gender can be M (for Male), F (for Female)," +
                            " or X (for Other), only.");
                } else {
                    ...
                    queue.addPatient(new PatientRecord(gender, age, triage));
            ...
            try {
                switch (command.charAt(0)) {
                    ...
                    case '2': // [2] Show the next patient record
                        // TODO
                        // Print the string representation of the patient record at
                    ...
                    case '3': // [3] See next Patient
                        ...
                        // add nextPatient to index 0 of the list of seenPatients

                      // by calling ArrayList.add(0,
                    ...
                    case '6': // [6] Clear the Care Admission Queue
                        System.out.println("Sorry! We are closed due to out " +
